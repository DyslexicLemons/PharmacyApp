...
from .routers import admin, auth, billing, dashboard, drugs, eprescribe, insurance, patients, prescriptions, prescribers, refills, rts
...
app.include_router(eprescribe.router,    prefix=API_PREFIX)
